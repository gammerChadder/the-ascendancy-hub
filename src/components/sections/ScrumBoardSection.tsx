  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100">Scrum Board</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        >
          <h3 className="font-medium text-lg mb-4 flex items-center text-gray-800 dark:text-gray-100">
          ...
          <div className="space-y-2">
            {data.scrumBoard
              ...
              .map((card) => (
                <Card
                  key={card.id}
                  className="cursor-move dark:bg-gray-900 dark:border-gray-700"
                  draggable
                ...
                >
                  ...
                  {card.description && (
                    <CardContent className="py-1 px-3 text-xs text-gray-600 dark:text-gray-300">
                      {card.description}
                    </CardContent>
                  )}
                </Card>
